...
/* harmony import */ var _modules_mobile_menu_mobile_menu__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/mobile-menu/mobile-menu */ "./js/modules/mobile-menu/mobile-menu.js");
/* harmony import */ var _modules_scroll_to_scroll_to__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/scroll-to/scroll-to */ "./js/modules/scroll-to/scroll-to.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_scroll_to_scroll_to__WEBPACK_IMPORTED_MODULE_2__["initScrollTo"])();
  Object(_modules_mobile_menu_mobile_menu__WEBPACK_IMPORTED_MODULE_1__["initMobileMenu"])();
  Object(_modules_phone_mask_phone_mask__WEBPACK_IMPORTED_MODULE_3__["getPhoneMask"])();
});
...
/*!***********************************************!*\
  !*** ./js/modules/mobile-menu/mobile-menu.js ***!
  \***********************************************/
/*! exports provided: closeMenu, initMobileMenu */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var siteNavigation = document.querySelector('.navigation');
var burgerButton = siteNavigation.querySelector('.navigation__menu-button');
var buttonLine = burgerButton.querySelector('.navigation__button-line');
...
var navigationLinks = document.querySelectorAll('.navigation__list-link');
var baseBlocks = document.querySelectorAll('section');
var initScrollTo = function initScrollTo() {
  navigationLinks.forEach(function (link) {
    link.addEventListener('click', function (evt) {
      evt.preventDefault();
      var rightBlock = Array.from(baseBlocks).find(function (block) {
        return block.id === "".concat(evt.target.id, "-block");
      });
      if (!rightBlock) {
        return;
      }
      rightBlock.scrollIntoView({
        behavior: 'smooth'
      });
      Object(_mobile_menu_mobile_menu__WEBPACK_IMPORTED_MODULE_0__["closeMenu"])();
    });
  });
};
